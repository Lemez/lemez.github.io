...
<h3>2013</h3>
<a href="{{alik[0].url}}">Alec Kopyt</a>, *Raw EP*, UK {% include music tag='production' %}{% include music tag='mix' %}{% include music tag='arrangement' %}  
...
<h4>Songwriting & Arrangement (Oi Va Voi)</h4>
...
<h4>Curation (Shtetl Superstars, Trikont)</h4> 
