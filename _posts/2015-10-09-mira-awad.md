...
{% include JB/sideimage img="miraawad.jpg" alt="Mira Awad" %}
...
{% include JB/video yt_id="Fv83u7-mNWQ" text="That great moment for you to savour again. And again. And again." %}
...
{% include JB/video yt_id="MtE-Qn_4iMU" text="Sadly only Hebrew and Arabic speakers can enjoy Arab Labor on Youtube. So, with apologies, a crass opinion piece." %}
...
{% include JB/video yt_id="v-kq7xcPcas" text='A classic Eurovision moment: going back to its <a href="https://en.wikipedia.org/wiki/Eurovision_Song_Contest#Origins" target="_blank">peacenik roots.</a>' %}
...
{% include JB/video yt_id="5iqZzi9mj4M" text="Mira Awad in discussion on stage." %}
...
{% include JB/video yt_id="wuLtQDs1Gb0" text="The official clip for this song has her cradling a rabbit. You're welcome." %}
